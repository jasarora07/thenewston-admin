...
export default function EquityCalculatorTerminal() {
  ...
  // We initialize results as null so the results panel stays hidden until the first click
  ...
  const handleInputChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    // We allow the user to type freely here without triggering the math
    ...
    <div className="max-w-4xl mx-auto space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-zinc-900/50 border border-white/5 p-6 rounded-2xl space-y-4">
          <h3 className="text-[10px] font-black uppercase tracking-widest text-zinc-500 flex items-center gap-2 italic text-zinc-500">
          ...
          <div className="space-y-4">
            <InputWrapper 
              ...
              tip="Use a recent appraisal or a conservative estimate from a site like Zillow. This helps determine how much equity you can safely use.">
            ...
            <div className="grid grid-cols-2 gap-4">
              <InputWrapper 
                ...
                tip="Check your most recent mortgage statement for your 'Remaining Principal'. This is how much you still owe on your main loan.">
              ...
              <InputWrapper 
                label="Locked Rate %" 
                tip="The interest rate you currently pay on your mortgage. We want to see if we can help you keep this low rate while still getting cash out.">
        ...
        <div className="bg-zinc-900/50 border border-white/5 p-6 rounded-2xl space-y-4 shadow-xl shadow-primary/5">
          ...
          <div className="space-y-4">
            <InputWrapper 
              label="Cash Required ($)" 
              tip="Enter the total amount of cash you need to take out of your home's value for your goals.">
            ...
            <div className="grid grid-cols-2 gap-4">
              <InputWrapper 
                label="HELOC Rate %" 
                tip="The current interest rate for a new HELOC. This is a separate, second loan that sits on top of your current mortgage.">
              ...
              <InputWrapper 
                label="Refi Rate %" 
                align="right"
                tip="The interest rate you would get if you replaced your entire mortgage today with one big new loan.">
      ...
      {/* TRIGGER BUTTON (Matches Tax model behavior) */}
      <div className="max-w-4xl mx-auto">
        <button 
          onClick={handleAnalyze} 
          className="w-full bg-white text-black px-10 py-4 rounded-xl font-black text-xs uppercase tracking-widest hover:bg-primary transition-all flex items-center justify-center gap-2 shadow-xl shadow-white/5 italic"
        >
          Execute Analysis <ArrowRight className="h-4 w-4" />
        </button>
      </div>

      {/* 4. STRATEGIC SIGNAL PANEL - Only shows when results is not null */}
      {results && (
          ...
          <div className="p-8 grid grid-cols-1 md:grid-cols-2 gap-8 items-center bg-black">
            ...
            <div className="flex flex-col items-center justify-center space-y-6 border-l border-white/5 font-bold">
               ...
               <div className="flex items-center gap-1 text-[8px] text-zinc-600 uppercase tracking-widest">
                 <ShieldCheck className="h-2 w-2" /> Session Verified for 2026 Rates
               </div>
            </div>
          </div>
        </div>
