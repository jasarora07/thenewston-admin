  ...
  return (
    <main className="container mx-auto px-4 py-16 bg-black min-h-screen flex flex-col items-center">
      <div className="max-w-4xl w-full">
        ...
        {/* 2. SELECTION CRITERIA (Restored for Authority) */}
          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-4">
              {[
                ...
                <li key={i} className="flex items-center gap-3 text-[10px] font-bold text-zinc-400 uppercase tracking-wider">
        ...
        {/* 4. DISCLAIMERS (Restored for Legal/SEO Compliance) */}
