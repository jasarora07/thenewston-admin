...
export default function TaxExemptWealthGap() {
  ...
  return (
    <div className="w-full text-white font-sans print:bg-white print:text-black print:p-0 print:max-h-screen print:overflow-hidden">
      ...
      {/* CORE WRAPPER GRID - Flattens out cleanly during print */}
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16 print:block print:space-y-6">
        ...
        <div className="lg:col-span-1 bg-zinc-900/50 border border-white/5 p-6 rounded-2xl space-y-6 shadow-xl print:border-none print:p-0 print:bg-transparent">
          ...
          <div className="space-y-4 print:grid print:grid-cols-3 print:gap-4 print:space-y-0">
            <div className="space-y-1 text-left">
              ...
              <div className="text-sm font-mono font-bold text-white print:text-black print:text-sm print:bg-zinc-100 print:p-2 print:rounded">
            ...
            <div className="space-y-1 text-left print:pt-0">
              ...
              <div className="text-sm font-mono font-bold text-[#22c55e] print:text-black print:text-sm print:bg-zinc-100 print:p-2 print:rounded">
                {taxRate}%
              </div>
            </div>
        ...
        <div className="lg:col-span-2 space-y-6 print:space-y-6">
          ...
          <div className="bg-zinc-900/50 border border-white/5 p-6 rounded-2xl space-y-4 print:border print:border-black print:rounded-none print:p-4 print:bg-transparent">
            ...
            <div className="grid grid-cols-2 gap-6 text-sm font-sans pt-1 print:grid-cols-2 print:gap-4">
              <div className="text-left">
                ...
                <p className="text-zinc-300 font-bold text-lg mt-0.5 print:text-black print:text-base">${data.taxableGrowthTotal.toLocaleString()}</p>
                <p className="text-[9px] text-zinc-400 font-medium tracking-tight mt-1 print:text-zinc-600">
                  {"Final performance yield facing ongoing multi-decade retail tax liquidations."} 
                </p>
              </div>

              <div className="text-left">
                <span className="text-[8px] uppercase tracking-widest text-[#22c55e] block print:text-black print:font-black">Tax-Exempt Alpha Matrix</span> 
                <p className="text-[#22c55e] font-bold text-lg mt-0.5 print:text-black print:text-base">${data.taxExemptGrowthTotal.toLocaleString()}</p>
                <p className="text-[9px] text-zinc-400 font-medium tracking-tight mt-1 print:text-zinc-600">
      ...
      {/* 📝 REGULATORY COMPLIANCE ATTESTATION (Prints beautifully at base) */}
      <div className="hidden print:block text-left mt-8 border-t border-black pt-4">
      ...
      {/* ❌ SCREEN-ONLY NAVIGATION ELEMENT CARD HUB (Hidden entirely when creating PDF) */}
