...
import { ShieldCheck, Landmark, TrendingUp, AlertTriangle } from "lucide-react"
    ...
    <div className="min-h-screen bg-black text-white font-sans flex flex-col">
      ...
      <main className="flex-1 container mx-auto px-4 py-12">
        ...
        <div className="max-w-5xl mx-auto grid grid-cols-1 gap-12">
          ...
          <section className="mt-12 border-t border-white/5 pt-12 pb-8">
            <div className="bg-zinc-900/30 border border-white/10 p-8 rounded-xl backdrop-blur-sm">
              ...
              <p className="text-[11px] text-zinc-500 font-bold uppercase leading-relaxed tracking-wider text-justify">
                ...
                Market conditions are volatile; users must consult with a <span className="text-zinc-300">Certified Financial Planner (CFP)</span> or a qualified tax professional before making any capital allocation decisions. 
