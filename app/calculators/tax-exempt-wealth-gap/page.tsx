        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 text-left">
          <div className="space-y-4">
            ...
            <p className="text-[11px] text-white font-bold leading-relaxed uppercase text-justify tracking-tighter">
              ...
              This module quantifies that loss over time, demonstrating how <span className="text-[#22c55e] font-black uppercase">Tax-Exempt Structural Alpha</span> outperforms taxable strategies.
            </p>
          </div>
          <div className="space-y-4">
            <div className="flex items-center gap-2">
            ...
            <p className="text-[11px] text-white font-bold leading-relaxed uppercase text-justify tracking-tighter">
              ...
              exceeding <span className="text-white font-black uppercase">40% of the total portfolio value</span> compared to tax-exempt structures.
            </p>
          </div>
        </div>
      </section>
