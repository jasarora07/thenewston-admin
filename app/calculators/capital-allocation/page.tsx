import { ShieldCheck, PieChart, HelpCircle, LayoutGrid, Wind, Info, TrendingUp, Lock } from "lucide-react"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 text-left">
          <div className="space-y-4">
            ...
            <p className="text-[11px] text-zinc-500 font-bold leading-relaxed uppercase tracking-tighter">
              In a taxable brokerage, every dividend payment creates a <span className="text-white font-black uppercase">Taxable Event</span>. This engine models "Dividend Drag" on compounding reserves.
            </p>
          </div>
          <div className="space-y-4">
            <div className="flex items-center gap-2">
            ...
            <p className="text-[11px] text-zinc-500 font-bold leading-relaxed uppercase tracking-tighter">
              Revealing the net liquidity of a taxable portfolio versus the raw, uninhibited exit velocity of a <span className="text-white font-black uppercase">Tax-Exempt</span> structure.
            </p>
          </div>
        </div>
      </section>
