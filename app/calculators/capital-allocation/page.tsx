import { ShieldCheck, PieChart, AlertTriangle, HelpCircle, LayoutGrid, Wind, Landmark, Info, TrendingUp } from "lucide-react"
...
export default function CapitalAllocationPage() {
  return (
    <main className="container mx-auto px-4 py-12">
      ...
      {/* 4. NAVIGATION HUB - Updated to include Module 05 Link */}
      <section className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6 py-12 border-t border-white/5 text-left">
        ...
        <Link href="/calculators/tax-exempt-wealth-gap" className="group p-6 bg-zinc-900/50 border border-white/5 hover:border-primary/50 transition-all rounded-xl">
          ...
          <p className="text-[9px] text-zinc-500 uppercase font-bold">Analyze annual tax leakage and capital appreciation alpha.</p>
        </Link>
