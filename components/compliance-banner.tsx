...
export function ComplianceBanner() {
  ...
  return (
    <div className="fixed bottom-0 left-0 w-full z-[100] p-4 animate-in fade-in slide-in-from-bottom-5 duration-500">
      <div className="container mx-auto max-w-6xl bg-zinc-950 border border-primary/30 shadow-[0_-10px_40px_-15px_rgba(34,197,94,0.2)] rounded-xl p-6 flex flex-col md:flex-row items-center justify-between gap-6 backdrop-blur-xl bg-opacity-95">
