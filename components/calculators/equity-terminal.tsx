    ...
    <div className="max-w-4xl mx-auto space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-zinc-900/50 border border-white/5 p-6 rounded-2xl space-y-4">
          ...
          <div className="space-y-4">
            <div className="group relative" title="Use a recent appraisal or a conservative estimate from a site like Zillow. This helps determine how much equity you can safely use.">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div title="Check your most recent mortgage statement for your 'Remaining Principal'. This is how much you still owe on your main loan.">
              ...
              <div title="The interest rate you currently pay on your mortgage. We want to see if we can help you keep this low rate while still getting cash out.">
        ...
        <div className="bg-zinc-900/50 border border-white/5 p-6 rounded-2xl space-y-4 shadow-xl shadow-primary/5">
          ...
          <div className="space-y-4">
            <div title="Enter the total amount of cash you need to take out of your home's value for your goals.">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="group relative" title="The current interest rate for a new HELOC. This is a separate, second loan that sits on top of your current mortgage.">
                <div className="flex items-center gap-2 mb-1">
                  <label className="text-[9px] font-bold text-zinc-600 uppercase cursor-help">HELOC Rate %</label>
                  <HelpCircle className="h-3 w-3 text-zinc-800" />
                  <div className="absolute left-0 bottom-full mb-2 w-48 p-2 bg-black border border-white/10 text-[8px] text-zinc-400 uppercase font-black rounded opacity-0 peer-hover:opacity-100 transition-opacity z-50">
                    The rate for a second, flexible line of credit.
                  </div>
                </div>
              ...
              <div className="group relative" title="The interest rate you would get if you replaced your entire mortgage today with one big new loan.">
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <div className="absolute right-0 bottom-full mb-2 w-48 p-2 bg-black border border-white/10 text-[8px] text-zinc-400 uppercase font-black rounded opacity-0 peer-hover:opacity-100 transition-opacity z-50 text-right">
                    The rate for a total mortgage replacement.
                  </div>
                </div>
      ...
      <div className="bg-zinc-900 border border-white/10 rounded-2xl overflow-hidden shadow-2xl">
        <div className={`p-4 flex items-center justify-between ${results.signal === 'HELOC' ? 'bg-green-600' : 'bg-primary'}`}>
          ...
          <span className="text-black/50 text-[10px] font-black uppercase" title="Loan-to-Value Ratio. Most lenders want to see this below 80% to keep your loans safe.">LTV Ratio: {results.ltv}%</span>
        </div>

        <div className="p-8 grid grid-cols-1 md:grid-cols-2 gap-8 items-center bg-black">
          <div className="space-y-6">
            <div className="space-y-1" title="This is your 'true' interest rate. It combines your cheap old mortgage and your new HELOC into one single percentage.">
